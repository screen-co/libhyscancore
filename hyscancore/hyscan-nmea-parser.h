 ...
 * @HYSCAN_NMEA_FIELD_HEADING: истинный курс
 ...
 * @HYSCAN_NMEA_FIELD_PITCH: дифферент
 * @HYSCAN_NMEA_FIELD_ROLL: крен
 *
...
typedef enum
{
 ...
 HYSCAN_NMEA_FIELD_PITCH,
 HYSCAN_NMEA_FIELD_ROLL,
} HyScanNMEAField;
