...
/**
 *
 * Функция переводит значение цвета из отдельных компонентов 
 * в упакованное 32-х битное значение
 *
...
/**
 *
 * Функция переводит значение цвета из 32-х битного значения
 * в 4 значения с плавающей точкой.
 *
