 ...
 *
 * В сочетании с интерфейсом класс позволяет всего лишь с помощью трех комманд узнавать глубину для заданного
 * индекса или времени и не задумываться обо всём остальном. Публично доступна только одна команда:
